...
public class PostToSOS {
	...
	private static void doPost(String apiKey, String valueA, String valueB){
		...
		String payload = "{\"version\": \"1.0.1\",\"observations\": [{\"sensor\": \"ILP_Sensor_grp2\",\"record\": [{\"starttime\": \"11-NOV-2015 15:31:45 IST\",\"output\": [{\"name\": \"distanceA\",\"value\": \"" + valueA + "\"}," + 
		 "{\"name\":\"distanceB\",\"value\":\"" + valueB + "\"}]}]}]}";

		try{
			// 1. URL
			URL url = new URL("http://tcup.web2labs.net:80/api/sos/v2.0/observations");
	...
	public String check(){
		...
		try{
			// 1. create url
			URL url = new URL("http://tcup.web2labs.net:80/api/sos/v2.0/observations?sensor=ILP_Sensor_grp2_result&time=latest");
	...
	public void postMessage(){
		String msg = "Alert!";
		HttpURLConnection conn = null;
		String payload = "{\"version\": \"1.0.1\",\"observations\": [{\"sensor\": \"message_grp2\",\"record\": [{\"starttime\": \"11-NOV-2015 15:31:45 IST\",\"output\": [{\"name\": \"message\",\"value\": \"" + msg + "\"}" + "]}]}]}";
